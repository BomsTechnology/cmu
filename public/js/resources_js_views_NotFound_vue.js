...
var _hoisted_1 = {
  "class": "flex items-center h-full sm:p-1"
};

var _hoisted_2 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createStaticVNode)("<div class=\"container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center text-gray-600 sm:max-w-lg text-\"><svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 512 512\" class=\"w-40 h-40 animate-pulse\"><path fill=\"currentColor\" d=\"M256,16C123.452,16,16,123.452,16,256S123.452,496,256,496,496,388.548,496,256,388.548,16,256,16ZM403.078,403.078a207.253,207.253,0,1,1,44.589-66.125A207.332,207.332,0,0,1,403.078,403.078Z\"></path><rect width=\"176\" height=\"32\" x=\"168\" y=\"320\" fill=\"currentColor\"></rect><polygon fill=\"currentColor\" points=\"210.63 228.042 186.588 206.671 207.958 182.63 184.042 161.37 162.671 185.412 138.63 164.042 117.37 187.958 141.412 209.329 120.042 233.37 143.958 254.63 165.329 230.588 189.37 251.958 210.63 228.042\"></polygon><polygon fill=\"currentColor\" points=\"383.958 182.63 360.042 161.37 338.671 185.412 314.63 164.042 293.37 187.958 317.412 209.329 296.042 233.37 319.958 254.63 341.329 230.588 365.37 251.958 386.63 228.042 362.588 206.671 383.958 182.63\"></polygon></svg><h2 class=\"mb-8 font-extrabold text-3xl\"> 404 Error </h2><p class=\"text-2xl font-semibold md:text-3xl\">Sorry, we couldn&#39;t find this page.</p><p class=\"mt-4 mb-8 text-coolGray-400\">But dont worry, you can find plenty of other things on our homepage.</p><a href=\"/\" class=\"text-white text-lg bg-blue-600 px-8 py-3\"> Back to homepage </a></div>", 1);
...
/* harmony import */ var C_laragon_www_cmu_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");

const script = {}

;
const __exports__ = /*#__PURE__*/(0,C_laragon_www_cmu_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_1__["default"])(script, [['render',_NotFound_vue_vue_type_template_id_5dcdfd0e__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/views/NotFound.vue"]])
/* hot reload */
if (false) {}
