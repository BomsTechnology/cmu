...
const { jobOffers, getJobOffers, loading, errors } =
    useJobOffers();
const keyWords = ref("");
...
const filteredJobOffer = computed({
    get() { return jobOffers.value.filter((jobOffer) => {
...
<div class="lg:flex py-4 md:px-10">
    ...
    <section class="max-w-4xl py-6 px-4 mx-auto text-center bg-white rounded-md border border-gray-300 dark:bg-gray-800">   
        <h2 class="text-lg font-semibold text-blue-600 capitalize dark:text-white">Filter Job Offer</h2>     
        <form>
            <div class="mt-4">
                <div>
    ...
    <div class="block lg:w-3/4 px-4 py-8">
            <div class="flex flex-col space-y-4 items-center px-6">
                <div v-if="filteredJobOffer.length != 0" v-for="job in filteredJobOffer" :key="job.id" class="w-full md:h-28 md:flex justify-between shadow border">
                   ...
                   <div class="p-2 text-center w-full md:text-left border-0 border-l px-2">
                       ...
                       <div class="flex justify-between items-center">
                           ...
                           <a :href="job.website" class="flex text-sm text-blue-600 hover:underline">
                           <span>
