    ...
    <div class="flex items-center justify-center  h-screen">
        <div class="w-full max-w-sm p-6  bg-white rounded-md shadow-md">
            <div class="flex justify-center items-center space-x-2">
                <h1 class="text-3xl font-semibold text-center text-blue-600"> CMU </h1>
            </div>
            ...
            <form @submit.prevent="login" class="mt-6">
                ...
                <div class="mt-6">
                    <button v-if="loading == 0" type="submit" class="text-white text-lg bg-blue-600 px-8 py-2 mt-6 w-full">Login</button>
