...
import Error from "../../../components/Error.vue";
    ...
    const { awards, getAwards, destroyAward, loading, errors } =
            useAwards();
        const searchKey = ref("");
    ...
    const filteredAward = computed({
        get() { return awards.value.filter((award) => {
                return award.title
                    .toLowerCase()
            ...
            >
                <div class="px-8 py-5 bg-white shadow-lg flex justify-between">
                    ...
                    >
                        ...
                        <p class="text-base leading-4">Add Award</p>
                    </router-link>
                </div>
                            ...
                            <div class="overflow-hidden">
                                ...
                                >
                                    ...
                                    <tbody
                                        ...
                                        v-if="filteredAward.length != 0"
                                    >
                                        <tr
                                            v-for="award in filteredAward"
                                            :key="award.id"
                                        ...
                                        >
                                           ...
                                           <td
                                            ...
                                            >
                                                <router-link :to="{name:'admin.awards.edit', params: {id: award.id }}"
                                                    href="#"
