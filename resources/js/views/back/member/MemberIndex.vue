...
import Error from "../../../components/Error.vue";
        ...
        const { members, getMembers, destroyMember, loading, errors } =
            useMembers();
        const searchKey = ref("");
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <img :src="member.avatar" v-if="member.avatar" alt="" class="w-16 rounded-full h-16 object-cover">
                                           ...
                                           <td
                                            ...
                                            >
                                                <router-link :to="{name:'admin.member.edit', params: {id: member.id }}"
                                                    href="#"
